...
def publish_message(
    ...
    if message_type == 'event':
        body = {'binary_data': base64.urlsafe_b64encode(message.encode()).decode()}
    else:
        body = {
          'state': {'binary_data': base64.urlsafe_b64encode(message.encode()).decode()}
        }
